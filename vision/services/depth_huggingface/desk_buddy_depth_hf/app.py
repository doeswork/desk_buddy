...
from .adapter import HuggingFaceDepthHandler


def main() -> None:
    parser = argparse.ArgumentParser(description="Desk Buddy Hugging Face depth MQTT worker")
    ...
    handlers = {
        model_id: HuggingFaceDepthHandler(
            model_id=model_id,
